...
class Auth {
    ...
    protected $_config = array(
        ...
        'AUTH_GROUP'        => 'AuthGroup',             //用户组数据表名 ApiAuthGroup
        'AUTH_GROUP_ACCESS' => 'AuthGroupAccess',       //用户组明细表 ApiAuthGroupAccess
        'AUTH_RULE'         => 'AuthRule',              //权限规则表 ApiAuthRule
        'AUTH_USER'         => 'User'                   //用户信息表 ApiUser
    );
