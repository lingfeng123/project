...
function C($param){
	$arr = [
		...
		'TOKEN_NAME'      => false,
		'TOKEN_RESET'     => false,
		'DEFAULT_M_LAYER' => false,
        'DB_PREFIX'       =>'api_',

        'DB_TYPE'         =>  'mysql',          // 数据库类型
        'DB_HOST'         =>  '139.199.10.155', // 服务器地址
        'DB_NAME'         =>  'kpzformaldata',  // 数据库名
        'DB_USER'         =>  'kpzweb',         // 用户名
        'DB_PWD'          =>  'HbMLn2zqbyKZV2fT',// 密码

		'DB_PORT'         => '3306',
		'DB_DSN'          => false,
		'DB_PARAMS'       => array(),
		'DB_CHARSET'      => 'utf8',
		'DB_DEPLOY_TYPE'  => false,
        ...
        "ALIDAYU"         => array(
            ...
            //短信模板
            "TEMPLATECODE" => array(
                "BIND_TEL_NUMBER" => "SMS_89960045",
                "VERIFY_PAY_PASSWORD" => "SMS_91885072",
                "SEAT_OVERDUE_NOTICE" => "SMS_94320020",
                "CANCEL_SANPACK" => "SMS_109545088", //散套
                "CANCEL_KAPACK" => "SMS_109405095", //卡套
                "CANCEL_SEAT" => "SMS_109370086", //卡座
                "RECEIVE_SEAT" => "SMS_96620016", //接收卡座订单
                "RECEIVE_SANPACK" => "SMS_96825015", //接收三套订单
                "RECEIVE_KAPACK" => "SMS_96730029", //接收卡套订单
                "OVERDUE" => "SMS_115250331", //即将逾期提醒
                "PRE_ARRIEVE" =>"SMS_114395684" //20分钟到店提醒
            )
        ),
